...
const punctualityRoutes = require('./routes/punctualityRoutes');
const giftGivingRoutes = require('./routes/giftGivingRoutes');
const restaurantReservationRoutes = require('./routes/restaurantReservationRoutes');
...
const queueCultureRoutes = require('./routes/queueCultureRoutes');
const taxiFareRoutes = require('./routes/taxiFareRoutes');
const restaurantPaceRoutes = require('./routes/restaurantPaceRoutes');
const currencyConvertibilityRoutes = require('./routes/currencyConvertibilityRoutes');
const attractionBookingRoutes = require('./routes/attractionBookingRoutes');
const shippingSouvenirsRoutes = require('./routes/shippingSouvenirsRoutes');
...
app.use('/api/tools', punctualityRoutes);
app.use('/api/tools', giftGivingRoutes);
app.use('/api/tools', restaurantReservationRoutes);
...
app.use('/api/tools', wasteDisposalRoutes);
app.use('/api/tools', queueCultureRoutes);
app.use('/api/tools', taxiFareRoutes);
app.use('/api/tools', restaurantPaceRoutes);
app.use('/api/tools', currencyConvertibilityRoutes);
app.use('/api/tools', attractionBookingRoutes);
app.use('/api/tools', shippingSouvenirsRoutes);
app.use('/api/tools', greetingRoutes);
