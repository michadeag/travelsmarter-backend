...
const TOOLS = [
  ...
  { url: 'lgbtq-travel-safety-checker.html', icon: '🏳️‍🌈', name: 'LGBTQ+ Travel Safety Checker', hook: 'Legal status swings wildly by destination', tip: "Same-sex relationships are legally recognized in some countries and criminalized in others just a short flight apart — laws and social climate have also been changing quickly in both directions recently, so always check current, city-level detail before you go." },
  { url: 'lounge-access-checker.html', icon: '🛋️', name: 'Airport Lounge Access Checker', hook: "Your Priority Pass might not work at your own hub", tip: "At airports dominated by one airline's own club network (Delta Sky Clubs at Atlanta, United Clubs at Chicago O'Hare and Newark), Priority Pass often gets you only a restaurant credit, not a real lounge — check your specific airport before counting on it." },
  { url: 'accessible-travel-checker.html', icon: '♿', name: 'Accessible & Wheelchair Travel Checker', hook: 'Historic charm and accessibility rarely go together', tip: "Modern hotels and museums are often genuinely accessible almost anywhere, but historic old towns — cobblestones, centuries-old stairs, narrow doorways — present real physical barriers that no amount of investment fully solves. Check the specific area you're visiting, not just the country in general." },
  { url: 'holiday-season-checker.html', icon: '📅', name: 'National Holiday Season Checker', hook: "Golden Week can wreck a trip you didn't even know you'd timed wrong", tip: "China's Spring Festival, Japan's Golden Week, Brazil's Carnival — these aren't single-day closures, they're weeks where transport books out and prices surge nationwide. Check your destination's disruptive season before you lock in dates, not after you can't find a hotel room." },
  { url: 'overweight-baggage-checker.html', icon: '🧳', name: 'Overweight & Oversized Baggage Fee Checker', hook: 'A 3-pound overage can cost more than your ticket', tip: "Budget carriers like Ryanair and Wizz Air charge per kilo for overweight bags — often €10-12/kg at the gate, versus a fraction of that if you pre-book extra weight online. A cheap luggage scale at home pays for itself the first time it saves you this fee." },
  { url: 'photography-permit-checker.html', icon: '📷', name: 'Photography & Filming Permit Checker', hook: 'Your tripod might need a permit you don\'t have', tip: "Casual photography is fine almost everywhere, but many major museums and monuments (the Louvre, Uffizi, Machu Picchu) charge a separate fee or require a permit just for a tripod — check the specific site's rules, not just the country's general laws, before you pack your gear." },
  { url: 'souvenir-export-checker.html', icon: '🛍️', name: 'Souvenir & Prohibited Export Items Checker', hook: 'That souvenir might not be legal to take home', tip: "Buddha statues in Thailand, ancient coins in Greece, ivory almost everywhere — some of the most tempting souvenirs are illegal to export without an official permit, or banned outright. Check before you buy, not after customs confiscates it." },
  { url: 'tourist-scams-checker.html', icon: '🎭', name: 'Common Tourist Scams Checker', hook: 'Know the #1 scam before you land', tip: "Every destination has one scam that catches tourists more than any other — a Budapest bar bill, a Bangkok tuk-tuk detour, a Rio distraction theft. Knowing what it looks like in advance is the best defense there is." },
  { url: 'lost-baggage-checker.html', icon: '🧳', name: 'Lost or Damaged Baggage Compensation Checker', hook: "Know what you're actually owed if your bag doesn't show up", tip: "Most travelers have no idea they're entitled to real compensation — up to $3,800 domestically or around 1,700 SDR internationally — if an airline loses or damages their checked bag. Knowing the number and the claim deadline before it happens means you won't leave money on the table." },
  { url: 'cash-declaration-checker.html', icon: '💵', name: 'Cash Declaration Limit Checker', hook: "Know the cash limit before customs finds out for you", tip: "Almost every country requires you to declare cash over a certain amount — often around $10,000, but sometimes much lower — and undeclared cash over the threshold can be seized outright, even if it's completely legitimate. Check the number for your destination before you pack your wallet." },
  { url: 'yellow-fever-checker.html', icon: '💉', name: 'Yellow Fever Certificate Requirement Checker', hook: "Some countries won't let you in without this specific certificate", tip: "It's easy to confuse general vaccine advice with an actual legal entry requirement — several countries require proof of yellow fever vaccination, sometimes for every traveler and sometimes only if you're arriving from an at-risk country. Show up without it where required, and you can be denied boarding or quarantined on arrival." },
  { url: 'digital-nomad-visa-checker.html', icon: '💻', name: 'Digital Nomad Visa Checker', hook: "Working remotely on this trip? Check if there's an actual visa for that", tip: "A growing list of countries now offer a dedicated digital nomad visa — Portugal, Spain, Costa Rica, Thailand's DTV, Colombia, and more — with real income requirements and durations that are completely different from a standard tourist visa. Worth checking before you assume you're covered." },
  { url: 'solo-female-travel-checker.html', icon: '🧭', name: 'Solo Female Travel Safety Checker', hook: "Traveling solo? Get the honest, destination-specific orientation", tip: "General crime advisories don't capture everything a woman traveling alone actually wants to know — unwanted attention risk, cultural norms, and practical tips vary a lot by destination. Get the honest picture before you go, not after." },
  { url: 'minor-consent-checker.html', icon: '👨‍👩‍👧', name: 'Minor Travel Consent Letter Checker', hook: "Traveling with your kid but not your co-parent? Check this first", tip: "South Africa is the famous example, but plenty of other countries — Mexico, Canada, several in Latin America — actively check for a notarized consent letter when a minor travels with only one parent or a non-parent. It's the cheapest insurance against a very bad day at the border." },
  { url: 'ramadan-checker.html', icon: '🌙', name: 'Ramadan Travel Impact Checker', hook: "Traveling to a Muslim-majority destination? Know what changes during Ramadan", tip: "Restaurant hours, public eating rules, and alcohol availability can shift significantly in destinations like Morocco, the UAE, or Malaysia during Ramadan — and the dates move about 10-11 days earlier every year. Knowing what to expect before you go turns a confusing surprise into an interesting part of the trip." },
  { url: 'halal-food-checker.html', icon: '🍽️', name: 'Halal Food Availability Checker', hook: "Wondering how easy it'll be to eat halal on this trip?", tip: "Halal availability ranges from 'the default everywhere' in places like Turkey and Malaysia to 'genuinely hard to find' in small Caribbean and Latin American destinations. Knowing which end of that range your destination falls on means you can plan ahead instead of scrambling once you land." },
  { url: 'kosher-food-checker.html', icon: '🍽️', name: 'Kosher Food Availability Checker', hook: "Wondering how easy it'll be to eat kosher on this trip?", tip: "Kosher availability follows a totally different map than halal — strongest in places like the US, Israel, the UK, and France, and Chabad Houses quietly serve travelers in a surprising number of other cities worldwide. Knowing what to expect before you go means you can plan ahead instead of scrambling once you land." },
  { url: 'car-rental-insurance-checker.html', icon: '🚗', name: 'Car Rental Deposit & Insurance Checker', hook: "Renting a car? Know the deposit and insurance quirks before you sign", tip: "A held deposit that runs into the thousands (Ireland, Iceland), a mandatory local insurance most travelers don't know about (Costa Rica), or aggressive upselling of coverage you may not need (Mexico) — every destination has its own rental-counter surprises. Knowing yours in advance means you walk in prepared, not caught off guard." },
  { url: 'pregnancy-travel-checker.html', icon: '🤰', name: 'Pregnancy Travel Risk Checker', hook: "Traveling while pregnant? Check the Zika risk for your destination", tip: "Zika risk isn't evenly spread — it's concentrated in parts of Latin America, the Caribbean, and Southeast Asia, and largely a non-issue elsewhere. Knowing where your destination falls, and talking it through with your OB/GYN, is worth doing before you book, not after." },
  { url: 'sports-equipment-checker.html', icon: '🏂', name: 'Sports Equipment Baggage Fee Checker', hook: "Packing skis, golf clubs, a surfboard, or a bike? Check this first", tip: "Most airlines have a completely separate policy for sports equipment that doesn't follow standard baggage rules — sometimes it's genuinely free as one of your checked bags (Southwest, Alaska), sometimes it's a flat special-item fee no matter what (the European budget carriers). Knowing which one applies before you pack saves a surprise at check-in." },
  { url: 'wedding-legal-checker.html', icon: '💍', name: 'Destination Wedding Legal Requirements Checker', hook: "Planning to legally marry abroad? Check the real requirements first", tip: "Some destinations (Denmark, most of the Caribbean) let you get legally married in a day or two with minimal paperwork. Others (France, Germany, most of Western Europe) require weeks of local residency before you can even apply — which is exactly why most couples there do a symbolic ceremony and handle the legal marriage at home instead. Know which category your destination falls into before you plan the ceremony." },
  { url: 'luggage-storage-checker.html', icon: '🧳', name: 'Left Luggage / Baggage Storage Checker', hook: "Got a late flight after checkout? Know where to stash your bags", tip: "Some destinations make this a non-issue — Japan's ubiquitous coin lockers, Europe's train-station storage plus apps like Bounce and Nannybag. Others genuinely don't have dedicated services, and hotel storage is your only real option. Knowing which one applies before your last day saves you dragging a suitcase around for six hours." },
  { url: 'public-restroom-checker.html', icon: '🚻', name: 'Public Restroom Availability & Etiquette Checker', hook: "The bathroom question nobody tells you the answer to before you go", tip: "Squat vs. Western toilets, bring-your-own-tissue habits, bins instead of flushing used paper — every destination has its own genuine etiquette quirks that catch first-time visitors off guard. A five-minute read before you go beats an awkward surprise once you're there." },
  { url: 'beach-safety-checker.html', icon: '🌊', name: 'Beach & Ocean Safety Checker', hook: "Heading somewhere with beaches? Know the real risks first", tip: "Rip currents kill more beach visitors than sharks, jellyfish, and every other ocean hazard combined — and destinations like Australia, Thailand, and Costa Rica have genuinely serious, well-documented risks worth knowing before you swim. A quick check before you go beats finding out the hard way." },
  { url: 'air-quality-checker.html', icon: '🌫️', name: 'Air Quality Checker', hook: "Planning outdoor time? Check what's actually in the air first", tip: "Air pollution isn't uniform even within a country — Delhi and Beijing see genuinely unhealthy days most winters, and even wildfire-prone destinations like the western US, Canada, and Australia can spike unexpectedly. If you have asthma or allergies, knowing before you go means packing the right gear." },
  { url: 'street-food-checker.html', icon: '🍜', name: 'Street Food Safety Checker', hook: "Nervous about street food? Here's what to actually watch for", tip: "The busy-stall rule is the single best predictor of safety almost everywhere — high turnover means fresher ingredients. Places like Singapore, Thailand, and Taiwan have street food so good and safe it's a genuine highlight, while destinations like India and Indonesia reward a bit more caution, especially with ice and pre-cut fruit." },
  { url: 'altitude-sickness-checker.html', icon: '⛰️', name: 'Altitude Sickness Checker', hook: "Headed somewhere high up? Know before you land", tip: "Cusco, Bogotá, Mexico City, and Kilimanjaro all sit high enough that altitude sickness is a real, well-documented risk — even for people in great shape, since fitness doesn't predict who gets hit. Knowing before you go means you can pace your first day or two instead of powering through a headache you didn't expect." },
  { url: 'onward-travel-checker.html', icon: '🎫', name: 'Proof of Onward Travel Checker', hook: "Traveling one-way? This could get you denied boarding", tip: "Thailand, Indonesia, New Zealand, Costa Rica, and Panama are notorious for actually enforcing proof of onward travel — sometimes right at the check-in counter, before you even board. One-way travelers get caught out by this constantly, and a refundable ticket or onward-travel-proof service fixes it for almost nothing." },
  { url: 'family-travel-checker.html', icon: '👨‍👩‍👧', name: 'Traveling with Kids Checker', hook: "Planning a family trip? Check the logistics before you book", tip: "Japan, Singapore, and the Nordics have exceptional stroller infrastructure and a genuinely warm culture toward kids in public — while destinations like India, Cambodia, and safari-focused Kenya and Tanzania come with real logistical friction for young children specifically, even though locals adore kids everywhere. Knowing before you book shapes whether you pack a stroller or a carrier." },
];
